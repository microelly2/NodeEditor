...
class trash():
    ...
    class FreeCAD_SimplexXXX(FreeCadNodeBase):
        '''
        Tetraeder
        '''
        ...
        def __init__(self, name="MySimplex"):
            ...
            self.n=self.createInputPin("noise", 'IntPin', True)
            self.n.recomputeNode=True

            self.nn=self.createInputPin("noiseA", 'IntPin', True)
            self.nn.recomputeNode=True
            ...
            self.createOutputPin('Shape_outX', 'ShapePin')
